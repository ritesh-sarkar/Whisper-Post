  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <AnimationWrapper
            variants={anonymousMessageProfileImageAnimationConfig(0.2)}
            once={true}
            className="
            w-20
            h-20
          ...
          <AnimationWrapper
            variants={anonymousMessageHeadingAnimationConfig(0.4)}
            once={true}
          >
            <h1
              className="
          ...
          <AnimationWrapper
            variants={anonymousMessageSubHeadingAnimationConfig(0.6)}
            once={true}
          >
            <p
              className="
        ...
        {/* Card */}
        <AnimationWrapper
          variants={anonymousMessageFormAnimationConfig(0.8)}
          once={true}
          className="
            w-full
            flex
